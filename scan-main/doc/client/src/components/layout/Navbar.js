...
const Navbar = (
        ...
        const authUserLinks = (
            <Fragment>
                ...
                Best Scan Center<img className="nav-log-img" style={{width: "3.2rem"}} src={require("./doctor (1).png")} />       
                </Link>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item active">
                            <Link to="/profiles" className="nav-link">Scans</Link>
                        </li>
                        <li className="nav-item active">
                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown active">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <Link className="dropdown-item" to="/loginDoctor"><i className="fas fa-user-md"></i> Login as Admin</Link>
                            </div>
                        </li>
                    <li className="nav-item dropdown active">
                            <Link className="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <Link className="dropdown-item" to="/registerDoctor"><i className="fas fa-user-md"></i> Register as Admin</Link>
                            </div>
                        </li>
                </ul>
                </div>
